...
(function(vue) {
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "content" }, [
      vue.createElementVNode("view", { class: "avatarWrapper" }, [
        ...
        vue.createElementVNode("view", null, [
          vue.createElementVNode("text", { class: "textQQ" }, "QQ")
        ])
      ]),
      vue.createElementVNode("view", { class: "form" }, [
        ...
        vue.createElementVNode("view", { class: "service" }, [
          vue.createElementVNode("view", null, [
            vue.createElementVNode("radio", { style: { "transform": "scale(0.7)" } }),
            vue.createElementVNode("text", { class: "accessText" }, [
              vue.createTextVNode("已阅读并同意"),
              vue.createElementVNode("text", { class: "textservice" }, "服务协议"),
              vue.createTextVNode("和"),
              vue.createElementVNode("text", { class: "textservice" }, "QQ隐私保护指引")
            ])
          ])
        ]),
        vue.createElementVNode("view", { class: "loginWrapper" }, [
          vue.createElementVNode("view", { class: "loginBtn" }, [
            vue.createElementVNode("image", {
              class: "imgright",
              src: "/static/right38.png",
              mode: "widthFix"
            })
          ])
        ])
      ]),
      vue.createElementVNode("view", { class: "otherchoice" }, [
        vue.createElementVNode("text", { class: "other" }, "手机号登录"),
        vue.createElementVNode("text", null, "|"),
        vue.createElementVNode("text", { class: "other" }, "新用户注册"),
        vue.createElementVNode("text", null, "|"),
        vue.createElementVNode("text", { class: "other" }, "更多选项")
      ])
    ]);
  }
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "D:/document/HBuilderProjects/hw01/pages/index/index.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "D:/document/HBuilderProjects/hw01/App.vue"]]);
  ...
  const b = true, k = "app", T = S([]), P = k, A = S(""), E = S('[{"provider":"aliyun","spaceName":"dragon-demo01","spaceId":"mp-50d47c37-3e9a-4a10-9357-1986932f2608","clientSecret":"Ljcjx/fViCMiGRJj+Ffw6g==","endpoint":"https://api.next.bspapp.com"}]') || [];
  let x = "";
  try {
    x = "";
  } catch (e) {
